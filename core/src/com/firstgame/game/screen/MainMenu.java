...
//import com.firstgame.game.savedGame;
...
public class MainMenu implements Screen {
    ...
    public MainMenu(final TankStars game){
        ...
        TextureAtlas atlas1 = new TextureAtlas(Gdx.files.internal("Menu/Images/Button/New game/button.atlas"));
        ...
        TextureAtlas atlas2 = new TextureAtlas(Gdx.files.internal("Menu/Images/Button/saved games/button.atlas"));
        ...
        TextureAtlas atlas3 = new TextureAtlas(Gdx.files.internal("Menu/Images/Button/Settings/button.atlas"));
        ...
        TextureAtlas atlas4 = new TextureAtlas(Gdx.files.internal("Menu/Images/Button/Exit/button.atlas"));
